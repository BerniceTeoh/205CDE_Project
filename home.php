...
<html lang="en">
  ...
  <body>
  <div class="container">
	<a class = "nav nav-pills pull-right" href="register.php">
	...
	<?php
		$sql = "SELECT id, company_name,username, email, password, contact FROM companyinfo";
	...
	<tr>
		...
		<td><a href='edit.php?edit=1&id=<?php echo $row["id"];?>'> Edit </a></td>
